 ...
 */
final class Version20211104133033 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE autorisation_sortie (id INT AUTO_INCREMENT NOT NULL, employer_id INT DEFAULT NULL, date_autorisation DATE NOT NULL, time TIME NOT NULL, valider TINYINT(1) DEFAULT NULL, refuser TINYINT(1) DEFAULT NULL, INDEX IDX_AEA917E441CD9E7A (employer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pointage (id INT AUTO_INCREMENT NOT NULL, employer_id INT DEFAULT NULL, horaire_id INT DEFAULT NULL, conger_payer_id INT DEFAULT NULL, autorisation_sortie_id INT DEFAULT NULL, work_time_id INT DEFAULT NULL, date DATE NOT NULL, entrer TIME DEFAULT NULL, sortie TIME DEFAULT NULL, nbr_heur_travailler TIME DEFAULT NULL, retard_en_minute TIME DEFAULT NULL, depart_anticiper TIME DEFAULT NULL, retard_midi TIME DEFAULT NULL, totale_retard TIME NOT NULL, abscence DOUBLE PRECISION DEFAULT NULL, heur_normalement_travailler TIME NOT NULL, diff TIME NOT NULL, INDEX IDX_7591B2041CD9E7A (employer_id), INDEX IDX_7591B2058C54515 (horaire_id), INDEX IDX_7591B202C8AA373 (conger_payer_id), INDEX IDX_7591B2062232238 (autorisation_sortie_id), INDEX IDX_7591B208B216519 (work_time_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
