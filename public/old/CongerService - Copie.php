...
class CongerService extends DateTimeService
{
    ...
    public function findOrCreate(?DateTime $entrer, ?DateTime $sortie): ?Conger
    {
        ...
        $maxDemiJourner->add($this->dateTimeToDateInterval($demiJourner));
        if (!$entrer and !$sortie) {
            ...
            $diff = $this->dateIntervalToDateTime($this->diffTime($entrer, $sortie));
